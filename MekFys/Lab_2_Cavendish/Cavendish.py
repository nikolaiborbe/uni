...
#filnavn = "S1data.txt" # [minutter, sekunder, S (mm)]
filnavn = "måling2.csv"
...
# Leser datafilen
D = np.loadtxt(filnavn, delimiter=",")
...
# Feilen av T kan regnes ut uten alpha, siden alpha er liten
